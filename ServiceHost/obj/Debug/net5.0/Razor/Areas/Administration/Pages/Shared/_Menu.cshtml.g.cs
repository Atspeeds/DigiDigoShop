#pragma checksum "C:\Users\A\source\repos\DigiDigoShop\ServiceHost\Areas\Administration\Pages\Shared\_Menu.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "60c85a091ad591bbfcb8a9a3ca726a632442be82"
// <auto-generated/>
...
namespace ServiceHost.Areas.Administration.Pages.Shared
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"60c85a091ad591bbfcb8a9a3ca726a632442be82", @"/Areas/Administration/Pages/Shared/_Menu.cshtml")]
    ...
    <div class=""main-sidebar-body"">
        ...
        ");
            ...
            <li class=""nav-item"">
                <a class=""nav-link with-sub"" href=""#""><span class=""shape1""></span><span class=""shape2""></span><i class=""ti-shopping-cart-full sidemenu-icon""></i><span class=""sidemenu-label"">فروشگاه</span><i class=""angle fe fe-chevron-left""></i></a>
                <ul class=""nav-sub"">
...
");
            WriteLiteral(@"                    <li class=""nav-sub-item"">
                    ...
                    <li class=""nav-sub-item"">
                        <a class=""nav-sub-link"" href=""/Administration/Shop/Slide"">اسلایدها</a>
                    </li>
            ...
            WriteLiteral(@"em"">
                ...
                <ul class=""nav-sub"">
                    ...
                    <li class=""nav-sub-item"">
                        <a class=""nav-sub-link"" h");
            WriteLiteral(@"ref=""icons05.html"">نمادهای یونی</a>
                    </li>
                    <li class=""nav-sub-item"">
          ...
          ");
            ...
            <li class=""nav-item"">
                ...
                <ul class=""nav-sub"">
                    ...
                    <li class=""nav-sub-item"">
                        <a class=""nav-sub-l");
            WriteLiteral(@"ink"" href=""avatar.html"">آواتار</a>
                    </li>
                    <li class=""nav-sub-item"">
            ...
            WriteLiteral(@" href=""typography.html"">تایپوگرافی</a>
                    </li>
                    <li class=""nav-sub-item"">
            ...
            <li class=""nav-item"">
                ...
                <ul class=""nav-sub"">
                    <li class=""nav-sub-item"">
                        <a class=""nav-sub-link"" href=""accordion.html"">آکاردئون</");
            WriteLiteral(@"a>
                    </li>
                    <li class=""nav-sub-item"">
          ...
          ");
            ...
            <li class=""nav-item"">
                ...
                <ul class=""nav-sub"">
                    ...
                    <li class=""nav-sub-item"">
                        <a class=""nav-sub-link"" href=""pr");
            WriteLiteral(@"icing.html"">قیمت گذاری</a>
                    </li>
                    <li class=""nav-sub-item"">
            ...
            <li class=""nav-item"">
                ...
                <ul class=""nav-sub"">
                    ...
                    <li class=""nav-sub-item"">
                    ");
            WriteLiteral(@"    <a class=""nav-sub-link"" href=""height.html"">قد</a>
                    </li>
                    <li class=""nav-sub-item"">
            ...
            <li class=""nav-item"">
                <a class=""nav-link with-sub"" href=""#""><span class=""shape1""></span><span class=""");
            WriteLiteral(@"shape2""></span><i class=""ti-lock sidemenu-icon""></i><span class=""sidemenu-label"">صفحات سفارشی</span><i class=""angle fe fe-chevron-left""></i></a>
                <ul class=""nav-sub"">
                    <li class=""nav-sub-item"">
